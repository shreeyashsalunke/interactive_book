...
void setup() {
  ...
  Serial.begin(9600);
  attachInterrupt(pbIn, stateChange0, RISING);
  attachInterrupt(pbOut, stateChange1, RISING);

}

void stateChange0()
{
Serial.println("In Interrupt0 Loop");
  switch (word_num) {
...
void stateChange1()
{
Serial.println("In Interrupt1 Loop");
  ...
  case 11:    // your hand is close to the sensor
    Serial.write(1);
    break;
  case 21:    // your hand is a few inches from the sensor
    Serial.write(2);
    break;
  case 31:    // your hand is nowhere near the sensor
    Serial.write(3);
    break;
  case 41:    // your hand is nowhere near the sensor
    Serial.write(4);
    break; 
  }   
  slide_num = 0;
